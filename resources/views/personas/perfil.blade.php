                ...
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    ...
                    <div id="myTabContent" class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                            ...
                            @else
                                <div class="alert alert-danger">
                                    No se encuentra su experiencia laboral, por favor haga click en el siguiente enlace y diligencie la información de su <a href"/personas/curriculo/experiencia-laboral">Experiencia Laboral</a>
                                </div>
                            @endif
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab_content3" aria-labelledby="profile-tab">
                            ...
                            @else
                                <div class="alert alert-danger">
                                    No se encuentra su experiencia laboral, por favor haga click en el siguiente enlace y diligencie la información de su <a href="/personas/curriculo/formacion">Formación</a>
                                </div>
                            @endif
                        </div>
                    </div>
